...
- **remote state พร้อม locking ต่อ cloud** state คือแหล่งความจริงว่ามีอะไรอยู่บ้าง การเก็บ state ไว้ใน backend ของแต่ละ cloud (S3 / GCS / Azure Storage) พร้อม locking คือสิ่งที่ให้ทีม — หรือ CI job — apply ได้อย่างปลอดภัยโดยไม่ทับกันเอง
...
- **CI/CD คือราวกันตก** `terragrunt plan` บน PR แสดงชัดว่าอะไรจะเปลี่ยนก่อนที่จะเปลี่ยนจริง; การ apply ตอน merge ทำให้ repo เป็นแหล่งความจริงหนึ่งเดียวของ platform
