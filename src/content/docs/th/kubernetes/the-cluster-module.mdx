...
output สามตัวนั้นคือสิ่งที่คุณต้องใช้เพื่อสร้าง kubeconfig หรือ config `kubernetes`/`helm` provider — นั่นคือเนื้อหาทั้งหมดของ [บทถัดไป](/clouddeploy/th/kubernetes/eks-gke-aks/)
